...
public class EmergencyCallbackModeService extends Service {
    ...
    private Phone mActivePhone = null;
    ...
    public void onCreate() {
        ...
        mActivePhone = ((com.android.internal.telephony.PhoneProxy) mPhone).getActivePhone();
    ...
    private BroadcastReceiver mEcmReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            // Show dialog box
                ...
                Log.d(LOG_TAG, "mOldSvlteSlotId:" + mOldSvlteSlotId
                        + ", svlteSlotId:" + svlteSlotId + ", mActivePhone:" + mActivePhone);
