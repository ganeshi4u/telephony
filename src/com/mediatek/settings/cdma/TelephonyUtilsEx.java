...
public class TelephonyUtilsEx {
    ...
    /**
     * Whether is LTE phone.
     * @param phone the phone object.
     * @return true if is LTE phone.
     */
    ...
    /**
     * Whether is CT cart type.
     * @return true if is CT cart type.
     */
   public static boolean isCTCardType(int slotId) {
    ...
    /**
     * Whether is CT LTE cart type.
     * @return true if is CT LTE cart type.
     */
   public static boolean isCTLTECardType(int slotId) {
    ...
    /**
     * Whether is CDMA cart type.
     * @return true if is CDMA cart type.
     */
    ...
    */
    public static boolean is4GDataOnly(Context context) {
        ...
        int subId[] = SubscriptionManager.getSubId(
